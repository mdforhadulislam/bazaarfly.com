    ...
    <section className="bg-white py-12 px-4 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto text-center relative z-10">
        ...
        >
          <Link
            href="/shop"
            className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-2 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all hover:-translate-y-0.5"
          >
            Shop Now
          </Link>
          ...
          <Link
            href="/category"
            className="bg-white/80 backdrop-blur border border-gray-300 hover:border-orange-500 hover:text-orange-600 px-8 py-2 rounded-xl font-semibold transition-all hover:-translate-y-0.5"
          >
            Browse Categories
          </Link>
        </motion.div>
