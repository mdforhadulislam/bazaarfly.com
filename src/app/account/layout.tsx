...
function Icon({ name }: { name: string }) {
  // small set of inline SVG icons (keeps dependency-free)
  switch (name) {
    case "home":
      return (
    ...
    case "bell":
      return (
        <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none">
          <path d="M15 17h5l-1.405-1.405A2.032 2.032 0 0 1 18.6 14.2C18.2 13.2 18 12.1 18 11V8a6 6 0 1 0-12 0v3c0 1.1-.2 2.2-.6 3.2a2.032 2.032 0 0 1-0.995 1.395L4 17h11z" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/>
